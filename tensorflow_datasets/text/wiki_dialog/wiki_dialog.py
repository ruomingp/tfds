...
class WikiDialogConfig(tfds.core.BuilderConfig):
  ...
  def __init__(self, name: str, base_download_url: str, **kwargs):
    ...
    """
    super(WikiDialogConfig, self).__init__(
        name=name,
        version=_VERSION,
...
class WikiDialog(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for WikiDialog from PTOQ inpainter."""
  VERSION = _VERSION
  ...
  BUILDER_CONFIGS = [
      WikiDialogConfig(
          ...
          description='WikiDialog generated from the dialog inpainter finetuned on OR-QuAC and QReCC.',
      ),
  ]
